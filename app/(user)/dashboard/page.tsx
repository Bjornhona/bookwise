            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 flex-1">
                ...
                <p className="text-yellow-700 mt-1">
                  ...
                  {pendingOrder.amount}) is being reviewed by our team.
                  You&apos;ll receive an email once your subscription is
                  ...
                  {orders.slice(0, 5).map((order) => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        <span
                          className={`inline-flex px-2 py-1 rounded-full text-xs font-semibold ${getOrderStatusColor(order.orderStatus)}`}
                        >
                          {order.orderStatus}
                        </span>
                      </div>
